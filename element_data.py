"""
Element data module for the Periodic Table Explorer.
Contains comprehensive information about chemical elements in multiple languages.
"""

# Complete periodic table data with multilingual support and properties
elements_data = {
    "1": {
        "symbol": "H",
        "names": {
    ...
    # Add more elements as needed to complete the periodic table
    # Elements 21-118 would follow the same pattern
}

# This allows using the file both as a module and standalone
if __name__ == "__main__":
    print(f"Total elements in database: {len(elements_data)}")
    print("Sample element (Hydrogen):")
